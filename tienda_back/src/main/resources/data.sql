...
INSERT INTO DRESS (SUBCATEGORY,SEX,BRAND,MODEL,CODE,STOCK,PRICE,AGE,SIZES,COLOR,ENABLED,IS_ON_FAVS)
    VALUES ('remeras','hombre','nike','A','AB045BA',TRUE,2900,'adultos','20','rojo',TRUE,FALSE);
INSERT INTO DRESS (SUBCATEGORY,SEX,BRAND,MODEL,CODE,STOCK,PRICE,AGE,SIZES,COLOR,ENABLED,IS_ON_FAVS)
    VALUES ('remeras','hombre','nike','A','AB045BB',FALSE,2900,'adultos','21','rojo',TRUE,FALSE);
INSERT INTO DRESS (SUBCATEGORY,SEX,BRAND,MODEL,CODE,STOCK,PRICE,AGE,SIZES,COLOR,ENABLED,IS_ON_FAVS)
	VALUES ('remeras','hombre','nike','A','AB045BC',TRUE,2900,'adultos','22','rojo',FALSE,FALSE);
INSERT INTO DRESS (SUBCATEGORY,SEX,BRAND,MODEL,CODE,STOCK,PRICE,AGE,SIZES,COLOR,ENABLED,IS_ON_FAVS)
	VALUES ('remeras','hombre','nike','B','AB045BD',TRUE,2900,'adultos','20','azul',FALSE,FALSE);
INSERT INTO DRESS (SUBCATEGORY,SEX,BRAND,MODEL,CODE,STOCK,PRICE,AGE,SIZES,COLOR,ENABLED,IS_ON_FAVS)
